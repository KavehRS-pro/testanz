var active_session, ip, user_id, timeout = 1, url = "http://192.168.115.153:8000/", system_id = "Developer",
...
function setCookie(e, t) {
    if (t) {
        var n = new Date;
        n.setMinutes(n.getMinutes() + timeout), document.cookie = "{0}={1}; expires={5000}".format(e, t, n.toUTCString())
    ...
    check: function () {
        ...
        if (ip) {
            ...
            if (user_id != e || !t) {
                ...
                return o.open("POST", "{0}api/session/".format(url), !0), o.setRequestHeader("Content-Type", "application/json"), o.setRequestHeader("Authorization", auth_token), o.onreadystatechange = function () {
